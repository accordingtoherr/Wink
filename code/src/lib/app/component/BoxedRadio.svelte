<script lang="ts">
	...
	export let selectedAccount: string | undefined
...
<label
	...
	<div class="form-check" >
		<input required {checked} {name} {disabled}{value} bind:group={selectedAccount}   on:click={() => selectOption(value, id)} type="radio" class="form-check-input me-1 " />
